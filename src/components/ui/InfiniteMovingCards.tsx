   ...
   // "relative z-20 overflow-hidden",
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-slate-700 px-8 py-6 md:w-auto"
            style={{
             // background:
          ...
          >
           ...
           {/*   <span className=" relative z-20 text-sm leading-[1.6] text-white font-normal">
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <div>
                    <img src={item.img} alt="profile" className="w-12 h-12" />
                </div>
